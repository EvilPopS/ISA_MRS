<template>
  <form @submit.prevent="handleSubmit">
        <img id="profilePic" @click="changeProfilePhoto()"  :src="setProfPic()" alt="Fishing Instructor profile picture should be here...">
    ...
    export default {
        ...
        methods: {
            handleSubmit(){
                ...
                axios.put("http://localhost:8080/api/fishingInstructor/data-update", requestBody)
                    .then(() => {
                        this.succMessage = "Azuriranje vasih licnih podataka je uspesno izvrseno!";
        ...
        props: ['picInp'],
        mounted() {
                axios.get("http://localhost:8080/api/fishingInstructor/" + "instructor@gmail.com")
                    .then((response) => {
